...
class Variant(models.Model):
    ...
    teacher = models.ForeignKey(to="click.Teacher", related_name='variants', on_delete=models.CASCADE)
...
class Result(models.Model):
    ...
    date_completed = models.DateTimeField('Bajarilgan vaqt', default=timezone.now)

    # date_started = models.DateTimeField('Boshlangan vaqt', default=timezone.now)
...
class UserAnswer(models.Model):
    result = models.ForeignKey(to='Result', related_name='user_answer', on_delete=models.CASCADE)
